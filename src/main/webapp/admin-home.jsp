...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><%=job.getRole() %></td>
            <td><%=job.getSalary()%></td>
            <td><a href="verify?id=<%=job.getId()%>"><button style="border: none;"><%if(job.getVerify().equalsIgnoreCase("yes")) {%><span style="color:green;">verified<span><%}else{%><span style="color:red;">verify-it<span><%} %></button></a></td>
        </tr>
