...
<body>
		...
		<div class="row">
			<div class="col-md-3 border-right">
				<div
					...
					<!-- image change button -->
					<button class="open-button" onclick="openForm()">change-profile-image</button>
				</div>
			</div>
	...
	<div class="form-popup" id="myForm">
		<form action="updateProfileImage" class="form-container" method="post" enctype="multipart/form-data">
